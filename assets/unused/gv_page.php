<?php
    ...
    $units = mysqli_query($mysqli, 
                        "SELECT * FROM unit_tb WHERE id_lo='GV'"
                        );
?>
...
<body>
    ...
    <div class="topnav">
        ...
        <form class="searchBar" action="../actions/search_unit.php" method="POST">
            <input type="text" name="search" placeholder="Cari dari Grand Valley">
            <button type="submit" name=submit-search-GV>Search</button>
        </form>
    </div>
    <!--Header==========================================================================-->
    ...
    <table height='50%' width='90%' border=1>
        ...
        <?php
            while($item = mysqli_fetch_array($units)) {
                ...
                echo "<td ><a class=\"tableButton\" href='../actions/delete_unit.php? id=$item[id_u]'>Delete</a></td></tr>";
            } 
        ?>
