<?php
    ...
    $units = mysqli_query($mysqli, 
                        "SELECT * FROM unit_tb WHERE id_lo='GP3'"
                        );
?>
    ...
    <div class="topnav">
        ...
        <div class="subnav">
            ...
            <div class="subnav-content">
                ...
                <a href="../pages/gp3_page_user.php">Grad Panorama 3</a>
            </div>
        </div>
        ...
        <form class="searchBar" action="../actions/search_unit_user.php" method="POST">
            <input type="text" name="search" placeholder="Cari dari Grand Panorama 3">
            <button type="submit" name="submit-search-GP3-user">Search</button>
        </form>
    </div>
     <!--Header==================================================================================-->
